...
pdf: init
	pandoc --standalone --template $(STYLES_DIR)/$(STYLE).tex \
		...
		$(IN_DIR)/header.md $(IN_DIR)/education.md $(IN_DIR)/jobs.md $(IN_DIR)/break.md $(IN_DIR)/other-jobs.md $(IN_DIR)/projects.md $(IN_DIR)/break.md $(IN_DIR)/technology.md $(IN_DIR)/workplace.md $(IN_DIR)/footer.md \
		> /dev/null; \
